...
/* ── DEMO DATA ── */
const DEMO_JOBS = [
  { id:'demo-01', po:'PO-2025-0841', supplier:'BakerGroup', ref:'KFC Ringwood — Combi Oven E35', equipment:'Combi Oven E35 20GN', poDate:'2025-01-08', status:'Job Done', value:'1480.00', buyer:'Peter Houchin', notes:'Fan motor replaced. Unit back in service.', history:[{status:'Incoming Job',date:'2025-01-08'},{status:'Job Booked',date:'2025-01-10'},{status:'Waiting for Parts',date:'2025-01-14'},{status:'Job Done',date:'2025-01-28'}] },
  { id:'demo-02', po:'PO-2025-0902', supplier:'Norfolk', ref:'Grill\'d Fitzroy — AM15 Dishwasher', equipment:'AM15 Pass-through Dishwasher', poDate:'2025-01-20', status:'Job Done', value:'920.00', buyer:'Lisa Tran', notes:'Rinse arm blocked. Descaled and replaced rinse nozzles.', history:[{status:'Incoming Job',date:'2025-01-20'},{status:'Job Booked',date:'2025-01-21'},{status:'Job Done',date:'2025-01-27'}] },
  { id:'demo-03', po:'PO-2025-1044', supplier:'KCI', ref:'McDonald\'s Doncaster — SCC WE 61', equipment:'SCC WE 61 Oven', poDate:'2025-02-03', status:'Job Done', value:'2150.00', buyer:'Peter Houchin', notes:'Control board replaced under extended warranty.', history:[{status:'Incoming Job',date:'2025-02-03'},{status:'Job Booked',date:'2025-02-05'},{status:'Waiting for Parts',date:'2025-02-10'},{status:'Revisiting',date:'2025-02-24'},{status:'Job Done',date:'2025-03-01'}] },
  { id:'demo-04', po:'PO-2025-1120', supplier:'BakerGroup', ref:'Subway Collins St — Proofer', equipment:'Proofer/Warmer Cabinet', poDate:'2025-02-14', status:'Job Done', value:'640.00', buyer:'Lisa Tran', notes:'Heating element failed. Replaced and tested.', history:[{status:'Incoming Job',date:'2025-02-14'},{status:'Job Booked',date:'2025-02-17'},{status:'Job Done',date:'2025-02-22'}] },
  { id:'demo-05', po:'PO-2025-1288', supplier:'Norfolk', ref:'Nando\'s Richmond — FT900 Dishwasher', equipment:'FT900 Flight Dishwasher', poDate:'2025-03-01', status:'Job Done', value:'3400.00', buyer:'Peter Houchin', notes:'Conveyor motor seized. Motor and belt assembly replaced.', history:[{status:'Incoming Job',date:'2025-03-01'},{status:'Job Booked',date:'2025-03-04'},{status:'Waiting for Parts',date:'2025-03-07'},{status:'Job Done',date:'2025-03-21'}] },
  { id:'demo-06', po:'PO-2025-1355', supplier:'UES', ref:'The Pancake Parlour — Air-o-Steam', equipment:'Air-o-Steam 61', poDate:'2025-03-12', status:'Job Done', value:'1760.00', buyer:'Lisa Tran', notes:'Steam generator calcified. Full descale + new gaskets.', history:[{status:'Incoming Job',date:'2025-03-12'},{status:'Job Booked',date:'2025-03-13'},{status:'Waiting for Parts',date:'2025-03-18'},{status:'Job Done',date:'2025-04-02'}] },
  { id:'demo-07', po:'PO-2025-1490', supplier:'KCI', ref:'Hungry Jack\'s Footscray — SCC 101', equipment:'SCC WE 101 Oven', poDate:'2025-03-25', status:'Job Done', value:'890.00', buyer:'Peter Houchin', notes:'Temperature probe replaced. Calibrated on-site.', history:[{status:'Incoming Job',date:'2025-03-25'},{status:'Job Booked',date:'2025-03-26'},{status:'Job Done',date:'2025-04-01'}] },
  { id:'demo-08', po:'PO-2025-1602', supplier:'BakerGroup', ref:'Boost Juice Chadstone — Blender Bank', equipment:'Waring Blender x4', poDate:'2025-04-07', status:'Job Done', value:'480.00', buyer:'Lisa Tran', notes:'Two blender couplings replaced. All four units tested OK.', history:[{status:'Incoming Job',date:'2025-04-07'},{status:'Job Booked',date:'2025-04-08'},{status:'Job Done',date:'2025-04-11'}] },
  { id:'demo-09', po:'PO-2025-1744', supplier:'Norfolk', ref:'Grill\'d Brunswick — LXeH Dishwasher', equipment:'LXeH Undercounter Dishwasher', poDate:'2025-04-15', status:'Job Done', value:'1120.00', buyer:'Peter Houchin', notes:'Door latch assembly and door gasket replaced.', history:[{status:'Incoming Job',date:'2025-04-15'},{status:'Job Booked',date:'2025-04-17'},{status:'Waiting for Parts',date:'2025-04-21'},{status:'Job Done',date:'2025-05-02'}] },
  { id:'demo-10', po:'PO-2025-1890', supplier:'UES', ref:'Cafe Greco South Yarra — PR2 Fridge', equipment:'PR2 Undercounter Fridge', poDate:'2025-04-28', status:'Job Done', value:'760.00', buyer:'Lisa Tran', notes:'Compressor start relay replaced.', history:[{status:'Incoming Job',date:'2025-04-28'},{status:'Job Booked',date:'2025-04-29'},{status:'Job Done',date:'2025-05-05'}] },
  { id:'demo-11', po:'PO-2025-2011', supplier:'KCI', ref:'McDonald\'s Southbank — SCC WE 101', equipment:'SCC WE 101 Oven', poDate:'2025-05-02', status:'Waiting for Parts', value:'2200.00', buyer:'Peter Houchin', notes:'Control display unit faulty. Part on order from Rational AU.', history:[{status:'Incoming Job',date:'2025-05-02'},{status:'Job Booked',date:'2025-05-05'},{status:'Waiting for Parts',date:'2025-05-08'}] },
  { id:'demo-12', po:'PO-2025-2055', supplier:'BakerGroup', ref:'KFC Northland — Turbofan E33D5', equipment:'Turbofan E33D5', poDate:'2025-05-05', status:'Job Booked', value:'550.00', buyer:'Lisa Tran', notes:'Thermostat not regulating. Technician booked 27 May.', history:[{status:'Incoming Job',date:'2025-05-05'},{status:'Job Booked',date:'2025-05-09'}] },
  { id:'demo-13', po:'PO-2025-2088', supplier:'Norfolk', ref:'Nando\'s Chadstone — FT900 Dishwasher', equipment:'FT900 Flight Dishwasher', poDate:'2025-04-28', status:'Revisiting', value:'1850.00', buyer:'Peter Houchin', notes:'First visit: cleared blockage. Unit failed again. Revisiting to check pump assembly.', history:[{status:'Incoming Job',date:'2025-04-28'},{status:'Job Booked',date:'2025-04-30'},{status:'Waiting for Parts',date:'2025-05-06'},{status:'Revisiting',date:'2025-05-14'}] },
  { id:'demo-14', po:'PO-2025-2103', supplier:'UES', ref:'The Pancake Parlour St Kilda — Griddle', equipment:'900XP Electric Griddle', poDate:'2025-05-10', status:'Incoming Job', value:'980.00', buyer:'Lisa Tran', notes:'Uneven heat across cooking surface. Needs diagnostics.', history:[{status:'Incoming Job',date:'2025-05-10'}] },
  { id:'demo-15', po:'PO-2025-2140', supplier:'KCI', ref:'Hungry Jack\'s Coburg — iCombi Pro 10', equipment:'iCombi Pro 10-1/1', poDate:'2025-05-12', status:'Waiting for Parts', value:'3100.00', buyer:'Peter Houchin', notes:'Steam injection system failure. Core unit needs replacement. ETA from supplier: 2 weeks.', history:[{status:'Incoming Job',date:'2025-05-12'},{status:'Job Booked',date:'2025-05-14'},{status:'Waiting for Parts',date:'2025-05-16'}] },
  { id:'demo-16', po:'PO-2025-2177', supplier:'BakerGroup', ref:'Subway Bourke St — Turbofan E23D3', equipment:'Turbofan E23D3', poDate:'2025-04-30', status:'Revisiting', value:'720.00', buyer:'Lisa Tran', notes:'Original repair didn\'t resolve intermittent fault. Booked for further diagnostics.', history:[{status:'Incoming Job',date:'2025-04-30'},{status:'Job Booked',date:'2025-05-02'},{status:'Revisiting',date:'2025-05-13'}] },
  { id:'demo-17', po:'PO-2025-2210', supplier:'Norfolk', ref:'Grill\'d Prahran — AM15 Dishwasher', equipment:'AM15 Dishwasher', poDate:'2025-05-15', status:'Job Booked', value:'430.00', buyer:'Peter Houchin', notes:'Wash pump making noise. Technician scheduled 28 May.', history:[{status:'Incoming Job',date:'2025-05-15'},{status:'Job Booked',date:'2025-05-16'}] },
  { id:'demo-18', po:'PO-2025-2244', supplier:'UES', ref:'Cafe Greco Richmond — Air-o-Steam', equipment:'Air-o-Steam Touchline 101', poDate:'2025-05-01', status:'Waiting for Parts', value:'1650.00', buyer:'Lisa Tran', notes:'Boiler element failed. Waiting on Electrolux to ship element kit.', history:[{status:'Incoming Job',date:'2025-05-01'},{status:'Job Booked',date:'2025-05-05'},{status:'Waiting for Parts',date:'2025-05-09'}] },
  { id:'demo-19', po:'PO-2025-2280', supplier:'BakerGroup', ref:'KFC Preston — Combi Oven E35', equipment:'Combi Oven E35', poDate:'2025-05-19', status:'Incoming Job', value:'870.00', buyer:'Peter Houchin', notes:'Error code E08 on display. Just received — awaiting booking.', history:[{status:'Incoming Job',date:'2025-05-19'}] },
  { id:'demo-20', po:'PO-2025-2301', supplier:'KCI', ref:'McDonald\'s Coburg — SCC WE 61', equipment:'SCC WE 61 Oven', poDate:'2025-05-20', status:'Incoming Job', value:'1100.00', buyer:'Lisa Tran', notes:'Unit displaying fault on self-clean cycle. Just logged.', history:[{status:'Incoming Job',date:'2025-05-20'}] },
  { id:'demo-21', po:'PO-2025-2055-M', supplier:'BakerGroup', ref:'Preventive Maintenance — KFC Northland Fleet', equipment:'Various — 6 units', poDate:'2025-05-08', status:'Maintenance', value:'2400.00', buyer:'Peter Houchin', notes:'Annual PM visit. Covers all Moffat units at KFC Northland. Scheduled 30 May.', history:[{status:'Maintenance',date:'2025-05-08'}] },
];

const DEMO_PARTS = {
  'demo-11': { eta: '2025-05-30', notes: 'Display unit — KCI part #CTR-4401' },
  'demo-15': { eta: '2025-06-02', notes: 'Steam core assembly — awaiting KCI stock' },
  'demo-18': { eta: '2025-05-28', notes: 'Boiler element kit — UES part #ELX-8821' },
};
